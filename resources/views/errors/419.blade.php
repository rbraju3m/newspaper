...
@section('code', \App\Support\Fmt::digits(419))
@section('heading', __('পাতাটির মেয়াদ শেষ হয়ে গেছে'))
@section('message', __('ফর্মটি অনেকক্ষণ খোলা ছিল বলে নিরাপত্তার কারণে বাতিল হয়েছে। পাতাটি নতুন করে খুলে আবার চেষ্টা করুন।'))
