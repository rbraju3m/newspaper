...
@section('code', \App\Support\Fmt::digits(404))
@section('heading', __('পাতাটি খুঁজে পাওয়া যায়নি'))
@section('message', __('ঠিকানাটি ভুল হতে পারে, অথবা খবরটি সরিয়ে নেওয়া হয়েছে। নিচে খুঁজে দেখতে পারেন।'))
...
@section('extra')
    ...
    <form action="{{ route('search') }}" method="get" class="flex gap-2">
        <label for="e404-q" class="sr-only">{{ __('খবর খুঁজুন') }}</label>
        <input id="e404-q" name="q" type="search" required
               placeholder="{{ __('খবর খুঁজুন') }}…"
...
@section('actions')
    <a href="{{ \App\Support\Locale::route('archive') }}"
