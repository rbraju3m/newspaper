...
@section('code', $code)
@section('heading', __('অনুরোধটি সম্পন্ন করা যায়নি'))
@section('message', __('অনুরোধটিতে কোনো সমস্যা ছিল বলে পাতাটি দেখানো যায়নি। ঠিকানাটি যাচাই করে আবার চেষ্টা করুন।'))
