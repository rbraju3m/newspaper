...
<rss version="2.0" xmlns:atom="http://www.w3.org/2005/Atom" xmlns:content="http://purl.org/rss/1.0/modules/content/">
  <channel>
    <title>{{ \App\Support\Locale::siteName() }}</title>
    <link>{{ \App\Support\Locale::route('home') }}</link>
    <description>{{ \App\Support\Locale::siteDescription() }}</description>
    <language>bn-BD</language>
    <lastBuildDate>{{ now()->toRfc2822String() }}</lastBuildDate>
    <atom:link href="{{ \App\Support\Locale::route('feed.rss') }}" rel="self" type="application/rss+xml"/>
